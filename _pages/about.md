...
social: false # includes social icons at the bottom of the page (navbar social is controlled in _config.yml)

announcements:
  enabled: true # includes the list of news items from _news/
